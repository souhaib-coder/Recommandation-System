  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingUser && formData.rôle !== editingUser.rôle) {
        await updateUserRole(editingUser.id_user, formData.rôle);
  ...
  if (loading && users.length === 0) {
    return (
      <div className="d-flex justify-content-center align-items-center" style={{height: "100vh"}}>
        <div className="fw-bold ms-3">Chargement des utilisateurs...</div>
      </div>
    );
  }
        ...
        <div className="container position-relative" style={{zIndex: "2"}}>
          <div className="row align-items-center">
            <div className="col-lg-8 py-3">
              ...
              <p className="lead opacity-90 mb-0">Consultez, modifiez ou supprimez les comptes utilisateurs de votre plateforme.</p>
            </div>
        ...
        {showEditForm && editingUser && (
          <div className="card border-0 shadow-sm mb-4" style={{borderRadius: "var(--border-radius-sm)"}}>
            <div className="card-header py-3 bg-transparent">
              <h5 className="mb-0">
                <i className="bi bi-person-gear me-2" style={{color: "var(--primary-color)"}}></i>
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div>
                <small className="text-muted">
                  Affichage de {indexOfFirstUser + 1}-{Math.min(indexOfLastUser, filteredUsers.length)} utilisateurs sur {filteredUsers.length} au total
                </small>
              </div>
